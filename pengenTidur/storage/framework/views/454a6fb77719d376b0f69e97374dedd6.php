...
<div class="header">
  ...
  <div style="display: flex; align-items: center; gap: 15px;">
    ...
    <a href="<?php echo e(route('profile')); ?>">
      <img src="<?php echo e(Auth::user()->profile_picture ?? asset('default-profile.png')); ?>" alt="Profile" class="profile-image">
    </a>
  </div>
</div>
  ...
  <div class="container">
    <div class="sidebar">
      <a class="sidebar-button" href="<?php echo e(route('home')); ?>">🏠<br/>Home</a>
      <a class="sidebar-button" href="<?php echo e(route('wallet')); ?>">👛<br/>Wallet</a>
      <a class="sidebar-button" href="<?php echo e(route('transfer')); ?>">🔁<br/>Transfer</a>
      <a class="sidebar-button" href="<?php echo e(route('trashpedia')); ?>">📄<br/>Trashpedia</a>
...
<div class="main-content">
  ...
  <div class="section">
    <div class="balance"><strong>RP <?php echo e(number_format($saldo,2,',','.')); ?></strong></div>
...
<?php /**PATH D:\Github\Project-Akhir-PEMWEB-pengeTidur\pengenTidur\resources\views/home1.blade.php ENDPATH**/ ?>